...
const CartItems = () => {
    ...
    const {all_product, addToCart,cartItems,removeFromCart,getCartTotalAmount} = useContext(ShopContext)
                ...
                return <div key={e.id}>
                            <div className='cartitems-format cartitems-format-main'>
                                ...
                                <div className='cartitems-quantity-plus-minus'>
                                    <img onClick={() => addToCart(e.id)} src={plus_sign} width="23px" height="23px"/>
                                    <img onClick={()=> removeFromCart(e.id)} src={minus_sign} width="23px" height="23px"/>
                                </div>
